...
use crate::bzlib::{BZ2_bzCompressEnd, BZ2_bzDecompressEnd, bz_stream};
use crate::bzlib::{
...
use crate::{
    ...
    BZ_RUN_OK, BZ_SEQUENCE_ERROR, BZ_STREAM_END, BZ_UNEXPECTED_EOF, BZ2_bzCompressInit,
...
#[unsafe(export_name = prefix!(BZ2_bzWriteOpen))]
...
///
/// [`pointer::as_mut`]: https://doc.rust-lang.org/core/primitive.pointer.html#method.as_mut
#[unsafe(export_name = prefix!(BZ2_bzWrite))]
...
///
/// [`pointer::as_mut`]: https://doc.rust-lang.org/core/primitive.pointer.html#method.as_mut
#[unsafe(export_name = prefix!(BZ2_bzWriteClose))]
...
///
/// [`pointer::as_mut`]: https://doc.rust-lang.org/core/primitive.pointer.html#method.as_mut
#[unsafe(export_name = prefix!(BZ2_bzWriteClose64))]
...
///
/// [`pointer::as_mut`]: https://doc.rust-lang.org/core/primitive.pointer.html#method.as_mut
#[unsafe(export_name = prefix!(BZ2_bzReadOpen))]
...
///
/// [`pointer::as_mut`]: https://doc.rust-lang.org/core/primitive.pointer.html#method.as_mut
#[unsafe(export_name = prefix!(BZ2_bzReadClose))]
...
///
/// [`pointer::as_mut`]: https://doc.rust-lang.org/core/primitive.pointer.html#method.as_mut
#[unsafe(export_name = prefix!(BZ2_bzRead))]
...
///
/// [`pointer::as_mut`]: https://doc.rust-lang.org/core/primitive.pointer.html#method.as_mut
#[unsafe(export_name = prefix!(BZ2_bzReadGetUnused))]
...
///
/// [`pointer::as_mut`]: https://doc.rust-lang.org/core/primitive.pointer.html#method.as_mut
#[unsafe(export_name = prefix!(BZ2_bzopen))]
...
///
/// [`pointer::as_mut`]: https://doc.rust-lang.org/core/primitive.pointer.html#method.as_mut
#[unsafe(export_name = prefix!(BZ2_bzdopen))]
...
///     - `b` is `NULL`
///     - `b` is initialized with [`BZ2_bzReadOpen`] or [`BZ2_bzWriteOpen`]
#[unsafe(export_name = prefix!(BZ2_bzflush))]
...
///     - `b` is `NULL`
///     - `b` is initialized with [`BZ2_bzReadOpen`] or [`BZ2_bzWriteOpen`]
#[unsafe(export_name = prefix!(BZ2_bzclose))]
...
///
/// [`pointer::as_mut`]: https://doc.rust-lang.org/core/primitive.pointer.html#method.as_mut
#[unsafe(export_name = prefix!(BZ2_bzerror))]
