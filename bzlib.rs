...
#[cfg_attr(
    feature = "export-symbols",
    unsafe(export_name = prefix!(BZ2_bzlibVersion))
)]
#[cfg(feature = "stdio")]
...
#[cfg_attr(
    feature = "export-symbols",
    unsafe(export_name = prefix!(BZ2_bzCompressInit))
)]
...
#[cfg_attr(
    feature = "export-symbols",
    unsafe(export_name = prefix!(BZ2_bzCompress))
)]
...
#[cfg_attr(
    feature = "export-symbols",
    unsafe(export_name = prefix!(BZ2_bzCompressEnd))
)]
...
#[cfg_attr(
    feature = "export-symbols",
    unsafe(export_name = prefix!(BZ2_bzDecompressInit))
)]
...
#[cfg_attr(
    feature = "export-symbols",
    unsafe(export_name = prefix!(BZ2_bzDecompress))
)]
...
#[cfg_attr(
    feature = "export-symbols",
    unsafe(export_name = prefix!(BZ2_bzDecompressEnd))
)]
...
#[cfg_attr(
    feature = "export-symbols",
    unsafe(export_name = prefix!(BZ2_bzBuffToBuffCompress))
)]
...
#[cfg_attr(
    feature = "export-symbols",
    unsafe(export_name = prefix!(BZ2_bzBuffToBuffDecompress))
)]
