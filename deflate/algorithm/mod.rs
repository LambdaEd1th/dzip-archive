...
pub static CONFIGURATION_TABLE: [Config; 10] = {
    [
        ...
        // zlib 1.1.3 uses the original lazy parser at level 6. zlib-rs tracks
        // zlib-ng here, whose medium parser produces a different bitstream.
        Config::new(8, 16, 128, 128, slow::deflate_slow), // 6
